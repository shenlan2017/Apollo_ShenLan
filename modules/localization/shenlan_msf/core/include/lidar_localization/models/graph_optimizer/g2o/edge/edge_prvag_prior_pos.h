 ...
 * @LastEditTime: 2022-09-25 19:56:11
 */
#ifndef LIDAR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_PRVAG_PRIOR_POS_H_
#define LIDAR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_PRVAG_PRIOR_POS_H_
...
class EdgePRVAGPriorPos
 ...
 public:
  ...
  virtual void computeError() override {
    const g2o::VertexPRVAG* v =
        static_cast<const g2o::VertexPRVAG*>(_vertices[0]);

    const Eigen::Vector3d& estimate = v->estimate().pos_;
...
#endif  // LIDAR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_PRVAG_PRIOR_POS_H_
