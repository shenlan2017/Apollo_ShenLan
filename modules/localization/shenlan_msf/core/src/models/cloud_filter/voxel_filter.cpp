 ...
 * @LastEditTime: 2022-09-22 21:10:29
 */
...
VoxelFilter::VoxelFilter(const float leaf_size_x,
                         const float leaf_size_y,
                         const float leaf_size_z) {
  SetFilterParam(leaf_size_x, leaf_size_y, leaf_size_z);
}

bool VoxelFilter::SetFilterParam(const float leaf_size_x,
                                 const float leaf_size_y,
                                 const float leaf_size_z) {
...
bool VoxelFilter::Filter(const CloudData::CloudTypePtr& input_cloud_ptr,
