...
void RobosenseDriver::preparePointsMsg(std::shared_ptr<PointCloud> msg) {
  ...
  if (conf_.use_lidar_clock()) {
    ...
    msg->set_measurement_time(cyber_timestamp);
  }
