...
if [ "${WORKHORSE}" = "cpu" ]; then
    ...
    echo "GPU_OPTIONS="-DWITH_CUDA=OFF""
fi
...
if [ "${TARGET_ARCH}" = "x86_64" ]; then
    ...
    echo "ARCH_OPTIONS="-DPCL_ENABLE_SSE=ON"
else
    ARCH_OPTIONS="-DPCL_ENABLE_SSE=OFF"
    echo "ARCH_OPTIONS="-DPCL_ENABLE_SSE=OFF"
fi
...
#VERSION="1.11.1"
#CHECKSUM="479f84f2c658a6319b78271111251b4c2d6cf07643421b66bbc351d9bed0ae93" # 1.11.1
